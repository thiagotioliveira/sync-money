...
class AccountRestControllerIT extends IntegrationTest {
  ...
  void createAccount() throws Exception {
    PostBankResponseBody bank =
        ITUtil.createBank(this.mockMvc, this.objectMapper, this.securityContext);
    PostAccountResponseBody account =
        ITUtil.createAccount(this.mockMvc, this.objectMapper, this.securityContext, bank.getId());
